...
모든 라우트의 공통 내비게이션에는 `← Bonifacio` 링크가 있습니다. 같은 탭에서 `https://bonifacio.work/`로 이동하며, 모바일에서는 safe area를 더한 최소 48px 상단 바에 표시되어 콘텐츠와 겹치지 않습니다. 온보딩처럼 앱 메뉴를 숨기는 화면에서도 이 복귀 링크는 유지됩니다.
